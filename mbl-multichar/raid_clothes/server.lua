...
RegisterServerEvent("wp-clothing:stealOutfit")
AddEventHandler("wp-clothing:stealOutfit", function(target)
    TriggerClientEvent("wp-clothing:stealOutfit", target, source)
end)

RegisterServerEvent("wp-clothing:letSteal")
AddEventHandler("wp-clothing:letSteal", function(cheater, outfit)
    TriggerClientEvent("wp-clothing:letSteal", cheater, outfit)
end)